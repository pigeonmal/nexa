...
Generated iOS projects use Xcode 16 project metadata and require Xcode 16 or newer. The generated host keeps the native SwiftUI output separate from Nexa compiler sources and does not emit legacy compatibility aliases.

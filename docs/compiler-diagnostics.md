...
- removes declared plugins that have no surviving typed native call or native-class constructor, so unused platform source trees are not copied into generated projects,

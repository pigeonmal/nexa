...
The first styling slice is implemented: `Text` accepts static `fontWeight` (`Normal`, `Medium`, `Semibold`, `Bold`) and positive `lineLimit`, lowering directly to SwiftUI and Compose text parameters. See [text-style.nx](examples/text-style.nx).

...
- Keep `Text` on native text rendering. Lower static `fontWeight` (`Normal`, `Medium`, `Semibold`, `Bold`) and positive `lineLimit` directly to SwiftUI modifiers and Compose text parameters; do not add a shared text layout runtime.

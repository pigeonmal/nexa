...
- Use `Text(value, fontWeight: Normal|Medium|Semibold|Bold, lineLimit: positiveInt)` for native text emphasis and static truncation. Swift and Compose receive direct native text styling; custom spans and selectable text are not part of the current syntax.
